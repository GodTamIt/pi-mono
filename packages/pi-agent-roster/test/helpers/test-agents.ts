/**
 * test-agents.ts — Agent configurations used only by behavioral tests.
 *
 * These fixtures preserve donor behavior without adding built-in agents to production discovery.
 */
...
4. Detail the design with step-by-step implementation strategy
