...
import type { SubagentManagerObserver } from "../../src/lifecycle/subagent-manager.ts";
import { CompositeSubagentObserver } from "../../src/observation/composite-subagent-observer.ts";
