...
import type { SubagentState } from "../lifecycle/subagent-state.ts";
import type { CompactionInfo, SubscribableSession } from "../types.ts";

export interface SubagentObserverOptions {
  onCompact?: ((info: CompactionInfo) => void) | undefined;
}
...
export function subscribeSubagentObserver(
  ...
  state: SubagentState,
  options?: SubagentObserverOptions | undefined,
): () => void {
